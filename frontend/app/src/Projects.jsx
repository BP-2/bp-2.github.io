      ...
      <div className="top-mobile">
        <h1 className="overall-heading-mobile">Here are some projects I have worked on outside of the classroom :)</h1>
          <div class="row list-group">
            ...
            <p className="project-description-mobile">Presented at: <a className="blue" href = "https://news.ohio.edu/news/2023/03/ohios-choose-ohio-first-scholars-present-ohio-statehouse">The Ohio State House</a> and <a className="blue" href = "https://projectboard.world/oas-annual-meeting/project/utilizing-parallelism-and-multithreading-for-iterative-refinement-of-antenna-pattern-visualization">The Ohio Academy of Science</a></p>
            <br/>
            ...
            <p className="project-description-mobile"><a className="blue" href = "https://devpost.com/software/sustainvr">DevPost</a> </p>
